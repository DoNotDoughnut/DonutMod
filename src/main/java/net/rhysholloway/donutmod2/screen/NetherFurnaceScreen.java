package net.rhysholloway.donutmod2.screen;
...
public class NetherFurnaceScreen extends HandledScreen<NetherFurnaceScreenHandler> {

	private final Identifier background = new Identifier(DonutMod.modId, "textures/gui/container/nether_furnace.png");

	public NetherFurnaceScreen(NetherFurnaceScreenHandler handler, PlayerInventory inventory, Text title) {
