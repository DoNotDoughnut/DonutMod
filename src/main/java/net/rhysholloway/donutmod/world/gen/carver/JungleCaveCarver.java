package net.rhysholloway.donutmod.world.gen.carver;
...
public class JungleCaveCarver extends CaveCarver {

	public JungleCaveCarver(Codec<ProbabilityConfig> codec, int i) {
		super(codec, i);
	}
