...
public final class DonutJungleHillsBiome extends Biome {

	public DonutJungleHillsBiome() {
		super(new Biome.Settings().configureSurfaceBuilder(SurfaceBuilderList.JUNGLE, SurfaceBuilderList.MUD_CONFIG).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.JUNGLE).depth(0.45F).scale(0.3F).temperature(0.95F).downfall(0.9F).effects((new BiomeEffects.Builder()).waterColor(4159204).waterFogColor(329011).fogColor(12638463).moodSound(BiomeMoodSound.CAVE).build()).parent((String) null));
