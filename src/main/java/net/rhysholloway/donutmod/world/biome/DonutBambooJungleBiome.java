...
public final class DonutBambooJungleBiome extends Biome {

	public DonutBambooJungleBiome() {
		super(new Biome.Settings().configureSurfaceBuilder(SurfaceBuilderList.JUNGLE, SurfaceBuilderList.MUD_CONFIG).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.JUNGLE).depth(0.1F).scale(0.2F).temperature(0.95F).downfall(0.9F).effects((new BiomeEffects.Builder()).waterColor(4159204).waterFogColor(329011).fogColor(12638463).moodSound(BiomeMoodSound.CAVE).build()).parent((String) null).noises(ImmutableList.of(new Biome.MixedNoisePoint(0.5F, 0.5F, 0.0F, 0.2F, 1.0F))));
