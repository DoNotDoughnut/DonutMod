...
public class AdamantiteSmeltingRecipe extends AbstractCookingRecipe {

	public static final Identifier recipeId = new Identifier(DonutMod.modId, "adamantite_smelting");
	public static RecipeType<AdamantiteSmeltingRecipe> TYPE = Registry.register(Registry.RECIPE_TYPE, recipeId, new RecipeType<AdamantiteSmeltingRecipe>() {
		public String toString() {
			return recipeId.toString();
		}
	});

	public static RecipeSerializer<AdamantiteSmeltingRecipe> SERIALIZER = new AdamantiteSmeltingRecipe.Serializer<AdamantiteSmeltingRecipe>(new AdamantiteSmeltingRecipe.Serializer.Factory(), 200);

	public AdamantiteSmeltingRecipe(Identifier id, String group, Ingredient input, ItemStack output, float experience, int cookTime) {
	...
	public static class Serializer<T extends AbstractCookingRecipe> implements RecipeSerializer<T> {
		...
		public static class Factory implements RecipeFactory<AdamantiteSmeltingRecipe> {

			@Override
			public AdamantiteSmeltingRecipe create(Identifier id, String group, Ingredient input, ItemStack output, float experience, int cookTime) {
				return new AdamantiteSmeltingRecipe(id, group, input, output, experience, cookTime);
			}
