...
import net.rhysholloway.donutmod1.util.DonutArmorMaterial;
...
public enum DonutArmorMaterials implements DonutArmorMaterial {
	...
	hallowed_basic("hallowed", 51, 1.0f, 0.2f, 15, new int[] { 3, 6, 7, 3 }, ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.ofItems(DonutItems.hallowed_ingot);}),

	hallowed_melee(hallowed_basic.getMaterialName(), "melee", 64, 1.0f, 0.2f, 15, new int[] { 3, 6, 7, 3 }, ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.ofItems(DonutItems.hallowed_ingot);}),
	
	hallowed_magic(hallowed_basic.getMaterialName(), "magic", 20, 1.0f, 0.2f, 15, new int[] { 3, 6, 7, 3 }, ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.ofItems(DonutItems.hallowed_ingot);}), 
	
	hallowed_ranged(hallowed_basic.getMaterialName(), "ranged", 36, 1.0f, 0.2f, 15, new int[] { 3, 6, 7, 3 }, ITEM_ARMOR_EQUIP_GENERIC, () -> { return Ingredient.ofItems(DonutItems.hallowed_ingot);});
